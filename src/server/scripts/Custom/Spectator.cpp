...
uint32 NejvetsiRating(Battleground* arena)
{
    ...
    uint32 biggestRating = 0;

    biggestRating = arena->GetArenaMatchmakerRating(firstTeamId);
    if (biggestRating < arena->GetArenaMatchmakerRating(secondTeamId))
        biggestRating = arena->GetArenaMatchmakerRating(secondTeamId);
